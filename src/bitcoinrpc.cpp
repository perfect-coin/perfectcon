...
{
    return GetBoolArg("-testnet", false) ? 25333 : 15333;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop PerfectCoin server (and possibly override the detachdb config value).");
...
void ThreadRPCServer2(void* parg)
{
    ...
    if (mapArgs["-rpcpassword"] == "")
    {
        ...
        string strWhatAmI = "To use PerfectCoind";
