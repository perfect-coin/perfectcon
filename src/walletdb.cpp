             ...
             bool& fIsEncrypted,  bool& fAnyUnordered, string& strType, string& strErr)
{
    try {
		...
		else if (strType == "stakeSplitThreshold") //presstab PerfectCoin
		{
            ssValue >> pwallet->nStakeSplitThreshold;
		}
		else if (strType == "multisend") //presstab PerfectCoin
		{
			unsigned int i;
			ssKey >> i;
		...
		else if(strType == "msettings")//presstab PerfectCoin
		{
