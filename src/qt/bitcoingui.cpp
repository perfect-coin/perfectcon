    ...
    rpcConsole(0)
{
    ...
    QString windowTitle = tr("PerfectCoin") + " - " + tr("Wallet");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a PerfectCoin address"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("PerfectCoin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PerfectCoin network", "", count));
}
