...
====================================
This guide will show you how to build perfectcoind(headless client) for OSX.
...
After exiting, you'll get a warning that the install is keg-only, which means it wasn't symlinked to `/usr/local`.  You don't need it to link it to build perfectcoin, but if you want to, here's how:

    $ brew link --force berkeley-db4


### Building `perfectcoind`
...
perfectcoind binaries are not included in the Perfectcoin-Qt.app bundle.

If you are building `perfectcoind` or `Perfectcoin-Qt` for others, your build machine should be set up
...
Once dependencies are compiled, you can use the following commands to configure and package the Perfectcoin-Qt.app
...
-------
    ...
    ./perfectcoin --help  # for a list of command-line options.
    ./perfectcoin help    # When the daemon is running, to get a list of RPC commands
